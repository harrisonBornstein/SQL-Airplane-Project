...
ALTER TABLE GROUP			ADD CONSTRAINT group_passngr_resrvtn_pk	PRIMARY KEY (passenger, reservation);
...
ALTER TABLE RESERVATION 	ADD (
	CONSTRAINT 	reservation_group_fk	FOREIGN KEY (group)
	REFERENCES 	GROUP(id),
...
ALTER TABLE GROUP 			ADD (
	CONSTRAINT 	group_passenger_fk	FOREIGN KEY (passenger)
	REFERENCES 	PASSENGER(id),
	CONSTRAINT 	group_reservation_fk	FOREIGN KEY (reservation)
	REFERENCES 	RESERVATION(id)
);
...
COMMIT;
/*
INSERT INTO GROUP (passenger, reservation) VALUES (valA, valB, ...);
COMMIT;
...
/*
INSERT INTO RESERVATION (id, group, flight, ccholder, customer) VALUES (valA, valB, ...);
COMMIT;
*/
